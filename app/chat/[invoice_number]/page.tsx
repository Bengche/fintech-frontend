          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
            ...
            <div className="h-1 bg-slate-100">
              <div
                ...
                style={{
                  width: `${(milestones.filter((m) => m.status === "released").length / milestones.length) * 100}%`,
                }}
              />
            </div>
          ...
          >
            ...
            {messages.map((msg) => {
              ...
              return (
                <div
                  key={msg.id}
                  className={`flex flex-col ${isBuyer ? "items-end" : isSystem || isModerator ? "items-center" : "items-start"}`}
                >
                  {/* Sender label */}
                ...
                <div className="w-full bg-slate-200 rounded-full h-1.5 overflow-hidden">
                  <div
                    ...
                    style={{
                      ...
                      backgroundColor:
                        uploadProgress < 100 ? "#f59e0b" : "#22c55e",
                    }}
                  />
                </div>
                <p
                  ...
                  style={{
                    color: uploadProgress < 100 ? "#b45309" : "#15803d",
                  }}
                >
                  {isUploading
          ...
          <div className="border-t border-slate-100 px-3 pb-3 pt-2">
            ...
            <div className="flex justify-end mt-1.5">
              {newMessage.length >= 1500 ? (
                ...
                <p
                  className={`text-xs ${newMessage.length >= 1200 ? "text-amber-500 font-medium" : "text-slate-400"}`}
                >
