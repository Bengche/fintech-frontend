          ...
          disputedMilestones.length > 0 && (
            <div className="card">
              ...
              >
                ...
                >
                  Scope:{" "}
                  {String(dispute?.dispute_scope ?? "full").toUpperCase()}
                </span>
                <span
                  style={{
                    fontSize: "0.8125rem",
              ...
              {effectiveEscrowAmount != null &&
                ...
                effectiveEscrowAmount < Number(dispute.disputed_amount) && (
                  ...
                  >
                    ⚠ Some milestones were released after this dispute was
                    opened. The effective amount (
                    {Number(effectiveEscrowAmount).toLocaleString()} XAF) is
                    less than the original disputed amount (
                    {Number(dispute.disputed_amount).toLocaleString()} XAF).
                    Only the current escrow balance will be disbursed.
                  </div>
                )}
        ...
        {!isResolved && (
          ...
          >
            ...
            {dispute?.status?.startsWith("partially_resolved") && (
              ...
              >
                ⚠ This dispute is partially resolved. Some milestones still
                require a decision. Use the milestone table above to resolve
                individual milestones, or use the global buttons below to
                resolve all remaining milestones at once.
              </div>
            )}
